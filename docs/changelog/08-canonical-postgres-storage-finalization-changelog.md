...
- Storage and contract documentation now describe selector-backed dependency reads, digest-backed PostgreSQL content storage, and the absence of identity/list compatibility state: [docs/schema.md](../../docs/schema.md), [docs/storage-strategy.md](../../docs/storage-strategy.md), [docs/overview.md](../../docs/overview.md), [docs/scope.md](../../docs/scope.md), [docs/prd.md](../../docs/prd.md).
