...
Goal: each step ends with a **complete, testable product** (a “vertical slice”), even if minimal. Steps are atomic and build cleanly toward the full repository.
...
### **Step 1 — Read-Only Skill Registry (MVP-0)**
